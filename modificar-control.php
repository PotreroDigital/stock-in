...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <br>
    <h3>¿Estas seguro que deseas modificar este producto?</h3>
    <br>
    ...
    include("funciones/modificar2.php");
    ...
    if ($q= "SELECT*FROM productos WHERE upc=$upc") {
      ...
      if ($fila2['upc']==$upc) {
        ...
        echo "<td>";
        ?>
        <form class="" action="funciones/modificacion.php" method="post" enctype="multipart/form-data">
          <input type="number" name="upc" value="<?php echo "$upc"; ?>" required class="form-control" placeholder="UPC">
        <?php
        /*echo $fila2 ["upc"];*/
        echo "</td>";
        echo "<td>";
        ...
        echo "<td>";
        ?>
          <input type="text" name="prod" value="<?php echo "$producto"; ?>" required class="form-control" placeholder="UPC">
        <?php
        /*echo $fila2 ["producto"];*/
        echo "</td>";
        echo "<td>";
        ?>
          <input type="text" name="categ" value="<?php echo "$categoria"; ?>" required class="form-control" placeholder="categoria">
        <?php
        /*echo $fila2 ["categoria"];*/
        echo "</td>";
        echo "<td>";
        ?>
          <input type="number" name="cant" value="<?php echo "$cantidad"; ?>" required class="form-control" placeholder="cantidad">
        <?php
        /*echo $fila2 ["cantidad"];*/
        echo "</td>";
        echo "<td>";
        ?>
          <input type="number" name="preciomenor" value="<?php echo "$preciomenor"; ?>" required class="form-control" placeholder="cantidad">
        <?php
        /*echo $fila2 ["precioxmenor"];*/
        echo "</td>";
        echo "<td>";
        ?>
          <input type="number" name="preciomayor" value="<?php echo "$preciomayor"; ?>" required class="form-control" placeholder="cantidad">
        <?php
        echo "</td>";
        echo "<td>";
        ?>
          <button class="btn btn-default" type="submit" name="button"><img class="" src="img/iconos-general/editar.png" alt="" width="20px" height="20px">&nbsp Modificar</button>
        </form>
        <?php
  ...
  <div class="separador-medio"></div><br>

  <form class="" action="funciones/modificar-imagen.php" method="post" enctype="multipart/form-data">
    <div class="container">
      <div class="row">
    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12 col-md-12">
          <div class="form-group">
            <div class=>
              <h4>Cambiar imagen de producto</h4><br><br>
              ...
              <input class="justify-content-center" type="file" name="imagen" value="">
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12 col-md-12">
          <div class="form-group">
            <div class="input-group">
            <button class="btn btn-default col-xs-12 col-md-12" type="submit" name="button"><img src="img/iconos-general/editar.png" alt="" width="20px" height="20px">&nbsp Modificar imagen</button>
            </div>
          </div>
        </div>
      </div>
