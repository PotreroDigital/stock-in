...
$modificar="UPDATE productos SET upc='$upc', imagen='$imagen', producto='$producto', categoria='$categoria', cantidad='$cantidad', precioxmenor='$preciomenor', precioxmayor='$preciomayor' WHERE upc=$upc";
